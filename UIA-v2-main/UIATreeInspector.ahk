...
class TreeInspector {
    ...
    __New() {
        ...
        this.GroupBoxMacro := this.gViewer.Add("GroupBox", "x1200 y20 w" (this.MacroSidebarWidth-20), "Macro creator") ; original
        ...
        (this.TextMacroAction := this.gViewer.Add("Text", "x1200 y40 w40", "Action:")).SetFont("bold") ; original
        ...
        ; (this.EditMacroScript := this.gViewer.Add("Edit", "-Wrap HScroll x1200 y65 h410 w" (this.MacroSidebarWidth-40), "#include <UIA>`n`n")).SetFont("s10") ; Setting a font here disables UTF-8-BOM ; original
        (this.EditMacroScript := this.gViewer.Add("Edit", "+Wrap VScroll x1200 y65 h410 w" (this.MacroSidebarWidth - 40), "#include <UIA>`n`n")).SetFont("s10")


        (this.ButMacroScriptRun := this.gViewer.Add("Button", "x1180 y120 w70", "&Test script")).SetFont("bold") ; original
